sap.ui.define([
    ...
    return Control.extend("ui5.walkthrough.control.ProductRating", {
        ...
        reset() {
            ...
            this.getAggregation("_label").setText(this._getText("productRatingLabelInitial"));
        ...
        _onSubmit(oEvent) {
            ...
            this.getAggregation("_label").setText(this._getText("productRatingLabelFinal"));
        ...
        _getText(sTextName,) {
            const oResourceBundle = this.getModel("i18n").getResourceBundle();
            return oResourceBundle.getText(sTextName);
        }
    });
});